            ...
            <div style={{ marginBottom: "30px", display: "flex", justifyContent: "center" }}>
                <div>
                    <div style={{ position: "relative", display: "inline-block" }}>
                        ...
                        <MapButton x={	80.13	} y={	47.81	} imagePath="../images_H3/		5_ScieRennepont.jpg	 " pointDescription="	La scie Rennepont	" onClick={handlePointClick} />		
                        <MapButton x={	83.33	} y={	47.66	} imagePath="../images_H3/		6_JeanLeScieur.jpg	 " pointDescription="	Jean, le scieur	" onClick={handlePointClick} />		
                        <MapButton x={	86.54	} y={	47.45	} imagePath="../images_H3/		7_PostPilotScie.jpg	 " pointDescription="	Poste de pilotage	" onClick={handlePointClick} />		
                        <MapButton x={	76.92	} y={	48.91	} imagePath="../images_H3/		8_TapisRoulant.jpg	 " pointDescription="	Tapis roulant	" onClick={handlePointClick} />		
                        ...
                        <MapButton x={	10.00	} y={	20.00	} imagePath="../images_H3/		23_Au fil de l'eau et... du bois.jpg	 " pointDescription="	Le silot à sciure	" onClick={handlePointClick} />		
                    </div>
                </div>
            </div>
