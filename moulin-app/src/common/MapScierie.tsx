        ...
        >
            ...
            <div style={{ display: "flex", justifyContent: "center", flex: 1, height: "100%" }}>
                <div style={{ position: "relative", display: "inline-block", height: "100%" }}>
                    ...
                    <MapButton x={79.4} y={47.5} imagePath="/images_H3/5_ScieRennepont.jpg" pointDescription="La scie Rennepont" onClick={handlePointClick} />
                    <MapButton x={84} y={46} imagePath="/images_H3/6_JeanLeScieur.jpg" pointDescription="Jean, le scieur" onClick={handlePointClick} />
                    <MapButton x={89} y={45} imagePath="/images_H3/7_PostPilotScie.jpg" pointDescription="Poste de pilotage" onClick={handlePointClick} />
                    <MapButton x={74.5} y={48.7} imagePath="/images_H3/8_TapisRoulant.jpg" pointDescription="Tapis roulant" onClick={handlePointClick} />
                    ...
                    <MapButton x={42.95} y={56.2} imagePath="/images_H3/12_GrandePiece.jpg" pointDescription="La grande pièce du moulin" onClick={handlePointClick} />
                    ...
                    <MapButton x={52.56} y={63.5} imagePath="/images_H3/21_HanguarCamions.jpg" pointDescription="Le hangar à camions" onClick={handlePointClick} />
